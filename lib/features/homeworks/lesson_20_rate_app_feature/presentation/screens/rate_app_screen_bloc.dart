...
class RateAppScreenBloc extends StatelessWidget {
  const RateAppScreenBloc({super.key});
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    BlocBuilder<RateAppBloc, RateAppBlocState>(
              ...
              TextButton.icon(
                onPressed: () => context.read<RateAppBloc>().add(
